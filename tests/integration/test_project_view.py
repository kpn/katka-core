...
class TestProjectViewSet:
    ...
    def test_filtered_list(self, client, logged_in_user, team, project, my_other_team, another_project):
    ...
    def test_filtered_list_non_existing_team(
        self, client, logged_in_user, team, project, my_other_team, another_project
    ):
